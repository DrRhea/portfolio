      ...
      <div className="qualification__container container">
        ...
        <div className="qualification__sections">
          <div className={toggleState === 1 ? "qualification__content qualification__content-active" : "qualification__content"}>
            ...
            <div className="qualification__data">
              <div className="">
                ...
                <span className="qualification__subtitle">Education University of Indonesia</span>
            ...
            <div className="qualification__data">
              ...
              <div className="">
                ...
                <span className="qualification__subtitle">Igasar Pindad High School</span>
                <div className="qualification__calender">
                  <i className="uil uil-calendar-alt"></i>
                  2018 - 2021
                </div>
          ...
          <div className={toggleState === 2 ? "qualification__content qualification__content-active" : "qualification__content"}>
            <div className="qualification__data">
              <div className="">
                <h3 className="qualification__title">Coding Tutor</h3>
                <span className="qualification__subtitle">RheClass</span>
                <div className="qualification__calender">
                  <i className="uil uil-calendar-alt"></i>
                  2023 - Present
                </div>
            ...
            <div className="qualification__data">
              <div className="">
                ...
                <span className="qualification__subtitle">RheCode</span>
                <div className="qualification__calender">
                  <i className="uil uil-calendar-alt"></i>
                  2022 - Present
                </div>
